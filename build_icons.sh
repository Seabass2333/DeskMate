...
# Directory setup
ICONSET="assets/images/icon.iconset"
mkdir -p "$ICONSET"
...
# Convert to icns
iconutil -c icns "$ICONSET" -o "assets/images/icon.icns"

# Cleanup
rm -rf "$ICONSET"
echo "✅ icon.icns generation attempt complete"
ls -l "assets/images/icon.icns"
